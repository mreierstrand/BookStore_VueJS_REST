...
var baseUrl = "http://anbo-bookstorerest.azurewebsites.net/api/Books";
new Vue({
    el: "#app",
    data: {
        books: [],
    ...
    methods: {
        ...
        addBook: function () {
            var _this = this;
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, this.formData)
                .then(function (response) {
                console.log(response.data);
                _this.addMessage = "Book Added";
                _this.getAllBooks();
            })
                .catch(function (error) {
                _this.errorMessage = error.message;
        ...
        deleteBook: function (deleteId) {
            ...
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(uri)
                .then(function (response) {
                _this.deleteMessage = "Book deleted";
                _this.getAllBooks();
            })
                .catch(function (error) {
                _this.errorMessage = error.message;
